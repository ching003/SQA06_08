...
- **Query Parameters**:
  ...
  - `orderBy`: string (optional, default: "createdAt:desc")

### Xử lý
1. Parse query parameters
2. Build where clause (isActive filter)
3. Query templates với pagination
4. Return list templates và pagination info
